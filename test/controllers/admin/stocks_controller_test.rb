...
class Admin::StocksControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create admin_stock" do
    assert_difference("Admin::Stock.count") do
      post admin_stocks_url, params: { admin_stock: { stock_quantity: @admin_stock.stock_quantity, product_id: @admin_stock.product_id } }
    end
  ...
  test "should update admin_stock" do
    patch admin_stock_url(@admin_stock), params: { admin_stock: { stock_quantity: @admin_stock.stock_quantity, product_id: @admin_stock.product_id } }
