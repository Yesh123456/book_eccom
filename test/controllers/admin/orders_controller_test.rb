...
class Admin::OrdersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create admin_order" do
    assert_difference("Admin::Order.count") do
      post admin_orders_url, params: { admin_order: { address: @admin_order.address, customer_email: @admin_order.customer_email, full_filled: @admin_order.full_filled, total_amount: @admin_order.total_amount } }
    end
  ...
  test "should update admin_order" do
    patch admin_order_url(@admin_order), params: { admin_order: { address: @admin_order.address, customer_email: @admin_order.customer_email, full_filled: @admin_order.full_filled, total_amount: @admin_order.total_amount } }
